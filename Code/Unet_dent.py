...
dent_directory = '/home/frieren/r12921062/Unet/data/training_real/img_slt'
dent_mask_directory = '/home/frieren/r12921062/Unet/data/training_real/mask_slt'
...
if os.path.exists('/home/frieren/r12921062/Unet/output') is False:
    os.makedirs('/home/frieren/r12921062/Unet/output')
...
plt.savefig(f'/home/frieren/r12921062/Unet/output/sample_image.png')
...
for i in range(4):
    ...
    plt.savefig(f'/home/frieren/r12921062/Unet/output/augmented_image_{i}.png')
...
mcp_save = ModelCheckpoint('/home/frieren/r12921062/Unet/models/AttentionUnet.tf', save_best_only=True, monitor='val_loss', mode='min')
...
#     plt.savefig(f'/home/frieren/r12921062/Unet/output/test_image_{i}.png')

#     print("X_test pixel range:", X_test[i].min(), X_test[i].max())
#     print("y_test pixel range:", y_test[i].min(), y_test[i].max())
...
model = load_model("/home/frieren/r12921062/Unet/models/AttentionUnet.tf", compile=False)
...
for test_img_number in test_img_list:
    ...
    plt.savefig(f'/home/frieren/r12921062/Unet/output/test_image_{test_img_number}.png')
...
for test_image_name, test_img in test_img_list:
    ...
    plt.savefig(f'/home/frieren/r12921062/Unet/output/test_image2_{test_image_name}.png')
...
for test_img_name, test_img in test_img_list:
    ...
    plt.savefig(f'/home/frieren/r12921062/Unet/output/test_image3_{test_img_name}.png')
